...
def test_get_table_names_with_sql_datasource(mocker):
...
def test_get_table_names_with_snowflake_datasource(mocker):
    mock_sqlalchemy_inspect = mocker.patch("great_expectations_cloud.agent.actions.utils.inspect")
...
def test_get_table_names_with_snowflake_datasource_no_schema(mocker):
    mock_sqlalchemy_inspect = mocker.patch("great_expectations_cloud.agent.actions.utils.inspect")
    datasource = mocker.Mock(spec=SnowflakeDatasource)
