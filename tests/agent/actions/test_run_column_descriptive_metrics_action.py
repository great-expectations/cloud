...
def test_run_column_descriptive_metrics_computes_metric_run_missing_batch_inspector(mocker):
    """
    ...
    mocker.patch("great_expectations_cloud.agent.actions.run_column_descriptive_metrics_action.BatchInspector")
