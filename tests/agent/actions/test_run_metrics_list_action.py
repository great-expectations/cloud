...
def test_run_metrics_list_computes_metric_run_missing_batch_inspector(
    ...
    mocker.patch("great_expectations_cloud.agent.actions.run_metric_list_action.BatchInspector")
    ...
    action._batch_inspector.compute_metric_list_run.assert_called_once()  # type: ignore[attr-defined]  # mypy thinks assert_called_once is not defined
