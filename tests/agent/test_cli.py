...
def test_command_retuns_zero_exit_code(cmd: str):
    ...
    # Note: 2024-09-18 Bumped timeout from 6->8 seconds to avoid flakiness on python 3.9
    cmplt_process = subprocess.run(cli_cmds, check=False, timeout=8.0)  # noqa: S603 # trusted input
