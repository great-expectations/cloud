...
class DraftDatasourceConfigActionV1(AgentAction[DraftDatasourceConfigEvent]):
    # TODO: New actions need to be created that are compatible with GX v1 and registered for v1.
    #  This action is registered for v0, see register_event_action()
...
register_event_action("1", DraftDatasourceConfigEvent, DraftDatasourceConfigActionV1)
