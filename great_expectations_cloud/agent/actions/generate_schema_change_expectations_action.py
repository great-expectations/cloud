...
class GenerateSchemaChangeExpectationsAction(AgentAction[GenerateSchemaChangeExpectationsEvent]):
    ...
    def run(self, event: GenerateSchemaChangeExpectationsEvent, id: str) -> ActionResult:
        ...
        # TODO: Revert this testing change:
        assets = ["local-mercury-db-organizations-table"]
        for asset_name in assets:
            # TODO: Revert this testing change:
            # for asset_name in event.data_assets:
            try:
                # TODO: Revert this testing change & clean up this method:
                ...
                #     "local-mercury-db-organizations-table - Default Expectation Suite"
                # )
                ...
                expectation_id = self._add_autogenerated_expectation_to_asset(expectation, asset_id)
                # self._set_expectation_as_autogenerated(expectation)
    ...
    def _retrieve_asset_from_asset_name(
        ...
        try:
            # TODO: Revert this testing change:
            datasource = self._context.data_sources.get("local_mercury_db")
    ...
    def _set_expectation_as_autogenerated(self, expectation: gx_expectations.Expectation) -> None:
        # TODO: Use the actual expectation id
        # TODO: Remove set_autogenerated from here and the backend in lieu of _add_autogenerated_expectation_to_asset
