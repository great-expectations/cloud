...
class GenerateSchemaChangeExpectationsAction(AgentAction[GenerateSchemaChangeExpectationsEvent]):
    ...
    def _add_autogenerated_expectation_to_asset(
        ...
        #     # TODO: What exception to raise and what should the error message be?
        #     raise GXAgentError(f"Failed to add autogenerated expectation: {response.text}")  # temp - need to figure out what to raise
...
# TODO: Revert this event change (used for testing):
