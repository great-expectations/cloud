...
class GenerateSchemaChangeExpectationsAction(AgentAction[GenerateSchemaChangeExpectationsEvent]):
    ...
    def run(self, event: GenerateSchemaChangeExpectationsEvent, id: str) -> ActionResult:
        ...
        for asset_name in assets:
            try:
                ...
                # )
                self._add_schema_change_expectation_rest_api()
    ...
    def _add_schema_change_expectation_rest_api(self):
        expectation_id = "3250fc7e-8769-4a48-8aa9-cf46a2476f41"
        url = urljoin(
            base=self._base_url,
            url=f"/api/v1/organizations/{self._organization_id}/expectations/{expectation_id}/set-autogenerated",
        )
    ...
    def _add_schema_change_expectation(
        ...
        # TODO: variables should be more like this:
        # variables = {
        #     "input": {
        ...
        variables = (
            {
                "input": {
                    "dataAssetId": str(data_asset_id),
                    "expectationConfiguration": json.dumps(
                        {
        ...
        # Headers are included in the create_session function
