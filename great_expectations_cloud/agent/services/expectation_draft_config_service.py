...
class ExpectationDraftConfigService:
    ...
    that can be shared between different actions like GenerateExpectationsAction.
    """
    ...
    def __init__(  # noqa: PLR0913
        ...
        workspace_id: UUID,
        created_via: str = CREATED_VIA_EXPECT_AI,
    ):
    ...
    def create_expectation_draft_configs(
        ...
        url = urljoin(
            base=self._base_url,
            url=f"/api/v1/organizations/{self._organization_id}/workspaces/{self._workspace_id}/expectation-draft-configs",
        )
        ...
        created_resources = [
            CreatedResource(resource_id=str(resource["id"]), type=EXPECTATION_DRAFT_CONFIG)
