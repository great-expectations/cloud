...
from great_expectations_cloud.agent.actions.types import CreatedResourceTypes
...
class ExpectationDraftConfigService:
    ...
    that can be shared between different actions like RdAgentAction and GenerateSqlExpectationAction.
    """
